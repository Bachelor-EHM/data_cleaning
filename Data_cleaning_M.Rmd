...
color_matching <- color_matching %>% 
  ...
  mutate(Secondary_focal = case_when(
          Color_label_matched == "seed mustard" ~ orange,
          Color_label_matched == "seed grass green" ~ yellow,
          Color_label_matched == "seed ocean blue" ~ green,
...
color_matching <- color_matching %>% 
  mutate(
    ...
    Dif_2 = Hue_matched - Secondary_focal,
    Rel_dif = 100/(Focal - Seed)*Dif,
    Rel_dif_2 = 100/(Seed - Secondary_focal)*Dif_2,
